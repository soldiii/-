...
private:
	...
	void CheckAdd(const Type&, const vector<StudyGroup*>&, const WeekType&, const Day&, const AudienceType&, const size_t&, const string&, const string&, const string&); // проверка данных занятия на правильность
public:
