...
private:
	...
	void AddAudience(AudienceType, const string&); // добавить аудиторию и присвоить ей тип
public:
	...
	void AddToSchedule(StudyGroup*,WeekType,Day,size_t,AudienceType, const string&, const string&, const string&); // добавление занятия в расписание группы 
	void Delete(size_t); // удаление группы
